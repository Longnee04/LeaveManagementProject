...
<%
    LeaveRequest lr = (LeaveRequest) request.getAttribute("requestDetails");
            ...
            <div class="page-header">
                <div>
                    ...
                    <ul class="breadcrumb-custom m-0 p-0 mt-1">
                        ...
                        <li class="breadcrumb-item-custom"><a href="${pageContext.request.contextPath}/admin/leave-requests"> / Tất cả đơn nghỉ</a></li>
                        <li class="breadcrumb-item-custom" style="color: var(--text-secondary);"> / Chi tiết</li>
                    </ul>
                </div>
                <a href="${pageContext.request.contextPath}/admin/leave-requests" class="btn-custom btn-secondary-custom">
                    ...
                    <div class="form-card">
                        ...
                        <div class="row g-4">
                            ...
                            <div class="col-12 col-sm-6">
                                <label class="d-block text-secondary mb-1" style="font-size: 0.8rem; font-weight: 600; text-transform: uppercase;">Nhân viên xin nghỉ</label>
                                <span class="d-block font-weight-bold" style="font-size: 1rem; font-weight: 600;">
                                    <%= lr.getEmployeeName() %>
                                </span>
                                <span class="text-muted small"><%= lr.getEmployeeEmail() %></span>
                            </div>

                            <div class="col-12 col-sm-6">
                                <label class="d-block text-secondary mb-1" style="font-size: 0.8rem; font-weight: 600; text-transform: uppercase;">Phòng ban</label>
                                <span class="d-block font-weight-bold" style="font-size: 1rem; font-weight: 600;">
                                    <%= lr.getDepartmentName() != null ? lr.getDepartmentName() : "Chưa phân bổ" %>
                                </span>
                            </div>
                            ...
                            <% if (lr.getManagerComment() != null && !lr.getManagerComment().isBlank()) { %>
                                <div class="col-12">
                                    ...
                                    <div class="p-3 alert-warning-custom shadow-none" style="border-radius: 8px; font-size: 0.95rem;">
                                        <i class="fa-solid fa-comment-dots me-2 text-warning"></i><strong>Quản lý phản hồi:</strong>
